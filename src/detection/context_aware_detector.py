...
INSTRUCTION_PATTERNS: tuple[InstructionPattern, ...] = (
    ...
    InstructionPattern(
        ...
        patterns=(
            ...
            "express your answer",
            "replace main keywords",
            "use emojis",
            "use emoji substitution",
            "use a caesar cipher",
            "substitution cipher",
            "base64",
            "base32",
        ...
        weight=0.82,
        description="External content tries to manipulate the assistant's response format or content.",
    ),
    InstructionPattern(
        ...
        patterns=(
            ...
            "how have global migration patterns",
            "how does social media marketing",
            "how can i automatically back up",
        ...
        weight=0.74,
        description="External content contains a standalone task likely unrelated to the user's requested task.",
    ),
)
