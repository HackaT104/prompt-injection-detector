...
Generated: `2026-06-21T20:07:49.497498+07:00`  
...
| Model | Type | Path | Parent | Train/Val/Test | Modified | Status | Artifact | Eval report |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Logistic Regression | TF-IDF + LogisticRegression | `F:\Capstone Project\prompt-injection-detector\models\logistic_regression_model.joblib` | N/A | prompt_injection_ml_ready.csv: 7275, stratified 80/20 | 2026-05-31 20:31:49 | trained | model + vectorizer | yes |
| Linear SVM | TF-IDF + calibrated LinearSVC | `F:\Capstone Project\prompt-injection-detector\models\linear_svm_model.joblib` | N/A | prompt_injection_ml_ready.csv: 7275, stratified 80/20 | 2026-05-31 20:31:50 | trained | model + vectorizer | yes |
| Random Forest | TF-IDF + RandomForestClassifier | `F:\Capstone Project\prompt-injection-detector\models\random_forest_model.joblib` | N/A | prompt_injection_ml_ready.csv: 7275, stratified 80/20 | 2026-05-31 20:31:53 | trained | model + vectorizer | yes |
| DistilBERT v4 | Transformer | `F:\Capstone Project\prompt-injection-detector\models\deprecated\distilbert_20260620_014520` | distilbert-base-uncased | jayavibhav: train 261588 / val 32699 / test 32699 | 2026-06-20 01:45:21 | trained; deprecated | weights + config + tokenizer | yes |
| RoBERTa v4 | Transformer | `F:\Capstone Project\prompt-injection-detector\models\transformers\roberta_v4` | roberta-base | jayavibhav: train 261588 / val 32699 / test 32699 | 2026-06-14 05:43:21 | trained; full fine-tune | weights + config + tokenizer | yes |
| RoBERTa v5 VI | Transformer | `F:\Capstone Project\prompt-injection-detector\models\transformers\roberta_v5_vi` | roberta_v4 | replay train 23400 / val 520 / VI test 1500 / EN test 32698 | 2026-06-20 03:20:29 | trained; continued full fine-tune | weights + config + tokenizer + args | yes |
| XLM-RoBERTa v4 | Transformer | `F:\Capstone Project\prompt-injection-detector\models\transformers\xlm_roberta_v4` | xlm-roberta-base | jayavibhav: train 261588 / val 32699 / test 32699 | 2026-06-14 05:43:21 | partially trained/head-only due OOM | weights + config + tokenizer | yes |
| XLM-RoBERTa v5 VI | Transformer | `F:\Capstone Project\prompt-injection-detector\models\transformers\xlm_roberta_v5_vi` | xlm_roberta_v4 | replay train 23400 / val 520 / VI test 1500 / EN test 32698 | 2026-06-20 14:25:20 | trained; continued full fine-tune | weights + config + tokenizer + args | yes |

# 3. Latest Evaluation Results

> Dataset khác nhau được ghi rõ; không so metric cross-domain như cùng test set.

| Model | Dataset | Eval th | Acc | Prec | Recall | F1 | F2 | AUC | AP | FP | FN | Recommendation |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| logistic_regression | vi_test_processed.csv (test, 1500) | 0.63 | 0.7647 | 0.6790 | 0.9150 | 0.7795 | 0.8555 | 0.8682 | 0.8200 | 295 | 58 | comparison baseline |
| linear_svm | vi_test_processed.csv (test, 1500) | 0.81 | 0.7460 | 0.6947 | 0.7874 | 0.7381 | 0.7669 | 0.8346 | 0.8120 | 236 | 145 | comparison baseline |
| random_forest | vi_test_processed.csv (test, 1500) | 0.62 | 0.6427 | 0.5647 | 0.9340 | 0.7039 | 0.8260 | 0.7957 | 0.7654 | 491 | 45 | comparison baseline |
| roberta_v5_vi | vi_test_processed.csv (test, 1500) | 0.05 | 0.9933 | 0.9927 | 0.9927 | 0.9927 | 0.9927 | 0.9997 | 0.9996 | 5 | 5 | primary runtime/demo |
| xlm_roberta_v5_vi | vi_test_processed.csv (test, 1500) | 0.37 | 0.7813 | 0.7185 | 0.8534 | 0.7802 | 0.8225 | 0.8703 | 0.8427 | 228 | 100 | warning-only multilingual auxiliary |
| distilbert_v4 | hf_prompt_injection_test.csv (test, 32699) | 0.81 | 0.9939 | 0.9923 | 0.9955 | 0.9939 | 0.9948 | 0.9996 | 0.9997 | 125 | 73 | deprecated historical comparison |
| roberta_v4 | vi_test_processed.csv (test, 1500) | 0.18 | 0.8273 | 0.7794 | 0.8651 | 0.8200 | 0.8465 | 0.9392 | 0.9311 | 167 | 92 | historical parent checkpoint |
| xlm_roberta_v4 | vi_test_processed.csv (test, 1500) | 0.27 | 0.7107 | 0.6260 | 0.9032 | 0.7395 | 0.8297 | 0.8495 | 0.8180 | 368 | 66 | historical partial/head-only |
